...
var meuTipoFabric = function (valor) {
    return {
        valor: valor
    };
};
...
let meuObjeto = { 1: 'a', 2: 'b', 3: 'c', 4: new MeuTipoConstructor('d'), 5: 'e', 6: meuTipoFabric('f') };
/**
...
Object.keys(meuObjeto).forEach((key) => {
    ...
    else if (meuObjeto[key] instanceof meuTipoFabric) {
        console.log(`Opa! '${meuObjeto[key].valor}' é uma instância do MeuTipoFabric!`);
    }
    else {
...
function imprimeResultado(nomeTeste, resultado) {
    if (!(resultado == 'FALSO')) {
